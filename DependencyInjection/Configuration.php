        ...
        $builder->root('mesd_jasper_report')
            ...
            ->children()
                ...
                ->arrayNode('presentation')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('openFolderIconClass')->defaultValue('icon-folder-open')->end()
                        ->scalarNode('closedFolderIconClass')->defaultValue('icon-folder-close')->end()
                        ->scalarNode('reportIconClass')->defaultValue('icon-file')->end()
                    ->end()
                ->end()
            ->end()
        ;
